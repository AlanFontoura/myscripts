...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download files from S3 based on date and client name.")
    parser.add_argument("-d", "--date", type=str, required=True, help="Date in YYYYMMDD format.")
    parser.add_argument("-c", "--client", type=str, required=True, help="Name of the client.")
